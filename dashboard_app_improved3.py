...
st.write(
    ...
    'It uses prepared summary files so the dashboard remains responsive and easy to navigate.'
)
...
if selected_section == 'Retail overview':
    ...
    st.write(
        'These values give a quick overview of the retail activity captured in the prepared dashboard data.'
    )
    ...
    st.write(
        'This section shows the strongest retail areas by sales value. '
        'The department and category patterns help explain why the dataset is useful for online retail machine learning.'
    )
